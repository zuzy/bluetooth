...
#include "softdevice_types.h"       // TODO: This will be moved to softdevice_handler.h in future.
...
void intern_softdevice_events_execute(void)
{
    ...
    for (;;)
    {
        ...
        if (!no_more_soc_evts)
        {
            ...
            // Pull event from SOC.
#if defined(S120_SUPPORT_REQD) || defined(S210_SUPPORT_REQD) || defined(S310_SUPPORT_REQD)
            // Experimental: The S120, S210, and S310 SoftDevices APIs have a differnt name for the 
